<div wire:ignore.self class="modal fade" id="editlargeModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div>
                    <input wire:model="nik" type="text" class="form-control form-sm" readonly>
                </div>

                <label for="name" class="form-label"><i class="ri-slack-fill"></i> Nama</label>
                <div>
                    <input wire:model="namalengkap" type="text" class="form-control form-sm" readonly>
                </div>
                ...
                <div>
                    <input wire:model="deptdesc" type="text" class="form-control form-sm" readonly>
                </div>


                <label for="jabdesc" class="form-label mt-2"><i class="ri-slack-fill"></i> Jabatan</label>
                <div>
                    <input wire:model="jabdesc" type="text" class="form-control form-sm" readonly>
                </div>
            ...
            <div class="modal-footer">
                ...
                <button wire:click.prevent="update()" wire:loading.attr="disabled" type="button" class="btn btn-warning">
                    <span wire:loading wire:target="update" class="spinner-border spinner-border-sm" role="status" aria-hidden="true"></span>
                    <i wire:loading.remove wire:target="update" class="ri-save-3-fill"></i>
                    Save changes
                </button>
            </div>
        </div>
