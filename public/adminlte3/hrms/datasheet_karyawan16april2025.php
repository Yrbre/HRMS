        ...
        <div class="col-lg-12">
          ...
          <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">Informasi <span>| Karyawan</span></h5>
                  ...
                  <table class="table table-hover datatable" cellspacing="0" width="200%">
                    ...
                    <?php        
                                    ...
                                    select nik, namalengkap, jkcode, jkdesc, jabdesc, deptdesc, deptcode, sexdesc, calgrp, grade, tglmasuk, masakerja, mk_thn, mk_bln, mk_hari
                                    ...
                                    {echo
                                      "<tr>
                                              ...
                                              <td align='center'><small>$mhs[nik]</small></td>
                                              ...
                                              <td align='center'> <i class='bi bi-folder2-open font-weight-bold text-primary fs-5'></i>
                                              <a class='text-info' href='cp_edit.php?edit=$mhs[id]';>&nbspDetail</a>&nbsp;</td>
                                        </tr>";
                                      $no++;
                                    }                    
                                ?>
