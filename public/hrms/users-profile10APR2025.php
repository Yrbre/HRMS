          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <ul class="nav nav-tabs nav-tabs-bordered">
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-edit">Career</button>
                </li>
                ...
                <li class="nav-item">
                  <button class="nav-link" data-bs-toggle="tab" data-bs-target="#profile-wp">Award & Punishment</button>
                </li>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    <div class="col-lg-3 col-md-4 small fst-italic fw-bold">Address</div>
                    <div class="col-lg-9 col-md-8 small label fw-bold">: Grandview Karawaci Cluster Monde Vista B3/15</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 small fst-italic fw-bold">Phone</div>
                    <div class="col-lg-9 col-md-8 small label fw-bold">: (436) 486-3538 x29071</div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 small small fst-italic fw-bold">Email</div>
                    <div class="col-lg-9 col-md-8 small label fw-bold">: suburharyawan@gmail.com</div>
                  </div>
                                                    ...
                                                    while ($mhs = mysqli_fetch_array($sql)) 
                                                    {
                                                        echo 
                                                            "<tr>
                                                                ...
                                                                <td align='left'><span class=' badge rounded-pill bg-primary'>$mhs[SBJ]</span></td>
